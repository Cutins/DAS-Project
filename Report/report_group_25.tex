...
\begin{tikzpicture}
  \def\scale{0.5} % Scala del disegno

  % Piani principali
  \filldraw[fill=blue!20] (0,0,0) -- (4*\scale,0,0) -- (4*\scale,0,3*\scale) -- (0,0,3*\scale) -- cycle;
  \filldraw[fill=red!20] (4*\scale,0,0) -- (4*\scale,4*\scale,0) -- (4*\scale,4*\scale,3*\scale) -- (4*\scale,0,3*\scale) -- cycle;
  \filldraw[fill=green!20] (0,0,3*\scale) -- (4*\scale,0,3*\scale) -- (4*\scale,4*\scale,3*\scale) -- (0,4*\scale,3*\scale) -- cycle;

  % Linee perimetrali
  \draw (0,0,0) -- (4*\scale,0,0) -- (4*\scale,4*\scale,0) -- (0,4*\scale,0) -- cycle;
  \draw (0,0,0) -- (0,0,3*\scale) -- (0,4*\scale,3*\scale) -- (0,4*\scale,0);
  \draw (0,4*\scale,0) -- (4*\scale,4*\scale,0) -- (4*\scale,4*\scale,3*\scale) -- (0,4*\scale,3*\scale);
  \draw (4*\scale,4*\scale,0) -- (4*\scale,0,0);
  \draw (4*\scale,0,0) -- (4*\scale,0,3*\scale) -- (4*\scale,4*\scale,3*\scale);

  % Etichette
  \node at (2*\scale,-0.6*\scale,0) {Piano XY};
  \node at (4.8*\scale,2*\scale,0) {Piano YZ};
  \node at (4*\scale,4.8*\scale,1.5*\scale) {Piano XZ};
