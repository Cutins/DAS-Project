...
\subsection{Results}
In the following we can see some results obtained during package simulations. 
...
At this point robots are partitioned in two groups, namely leaders and followes. The objective of this task is to control the translation and/or the rotation of the formation (by giving proper inputs to the leaders) while maintaining the chosen pattern.
